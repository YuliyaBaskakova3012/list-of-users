...
2. Пока идет загрузка списка пользователей предусмотрен индикатор загрузки.
3. Выводятся на карточку:
 - name
 - address.city
 - company.name
4. Кнопка “Подробнее” ведет на “Профиль пользователя”
5. Реализована фильтрация списка по признаку Name и City в алфавитном порядке
...
3. Реализована кнопка изменить, изначально поля readonly, после нажатия на кнопку поля можно редактировать
...
* Webpack
* Библиотека Lodash
### Просмотр итогового вида SPA доступен по ссылке: https://jealous-flight.surge.sh/
